...
export default function DropDownButton({ href, id, icon: Icon, onClick, iconSize = 20, iconStrokeWidth = 1, title, active, chevron = true }) {
    ...
    return (
        ...
        >
            <a className="w-full flex items-center justify-between text-foreground">
                ...
                {
                    chevron && isActive ? (
                        <BiChevronDown size={18} strokeWidth={0.8} />
                        ) : (
